...
Бот и веб-сервер работают в 1 процессе, 1 потоке.
## База данных
...
* Необходимо нормально реализовать REST API, а не то, что имеем сейчас - всё что можно ТСД будет фигачить через POST?
