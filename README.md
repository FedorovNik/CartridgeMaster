...
* учёта количества картриджей с помощью Android терминала со встроенным сканером
* хранения актуального количества расходников (картриджей) на складе
* хранения логов расхода и прихода расходников.

Логически разделено на 2 модуля:
- Телеграм бот.
- Локальный веб-сервер, для обмена данными с приложением CartridgeScanner.

Информация об используемых версиях и зависимостях в файле requirements.txt  
В корне приложен докерфайл для развертывания в docker
